#!/bin/bash
#SBATCH --job-name=cl_spatial_clip
...
#SBATCH --output=logs/cl_spatial_clip_%j.log
#SBATCH --error=logs/cl_spatial_clip_%j.log
...
/home/kyn7666/anaconda3/envs/lerobot/bin/python -m scripts.train_sequential \
    --config configs/cl_spatial_clip_s220.yaml

#!/bin/bash
#SBATCH --job-name=cl_goal_sdft_clip
...
#SBATCH --output=logs/cl_goal_sdft_clip_%j.log
#SBATCH --error=logs/cl_goal_sdft_clip_%j.log
...
/home/kyn7666/anaconda3/envs/lerobot/bin/python -m scripts.train_sequential_sdft \
    --config configs/cl_goal_sdft_clip_l0.1_s220.yaml

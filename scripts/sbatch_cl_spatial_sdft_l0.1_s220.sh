#!/bin/bash
#SBATCH --job-name=cl_spatial_sdft_l01_s220
...
#SBATCH --output=logs/cl_spatial_sdft_l0.1_s220_%j.log
#SBATCH --error=logs/cl_spatial_sdft_l0.1_s220_%j.log
...
/home/kyn7666/anaconda3/envs/lerobot/bin/python -m scripts.train_sequential_sdft \
    --config configs/cl_spatial_sdft_l0.1_s220.yaml \
